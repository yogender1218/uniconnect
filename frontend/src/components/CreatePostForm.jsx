...
const CreatePostForm = ({ 
  ...
  return (
    <Card className={cn("glass-card", className)} style={{border:'1px solid var(--border-color)', borderRadius:'10px', backgroundColor:'var(--blur-bgcolor)'}}>
      <form onSubmit={handleSubmit}>
        <CardContent className="p-4 pt-5">
          <Textarea style={{border:'1px solid var(--border-color)', borderRadius:'10px', backgroundColor:'var(--blur-bgcolor)'}}
          ...
          {/* Hidden file inputs */}
          <input style={{border:'1px solid var(--border-color)', borderRadius:'10px', backgroundColor:'var(--blur-bgcolor)'}}
            type="file" 
            ref={imageInputRef} 
            className="hidden" 
            accept="image/*" 
