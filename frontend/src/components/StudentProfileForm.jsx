...
const StudentProfileForm = () => {
  ...
  return (
    <Card style={{border:'1px solid var(--border-color)', borderRadius:'10px', backgroundColor:'var(--card-bgcolor)',width:'80%', margin:'22px 2px 12vw 15.3vw',justifyContent:'center',alignItems:'center'}}>
      <CardHeader>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-1">
            <div className="space-y-2">
              ...
              <Input style={{border:'1px solid var(--border-color)', borderRadius:'10px', backgroundColor:'var(--card-bgcolor)'}}
                id="university" 
                {...register("university")} 
          ...
          <div className="space-y-2">
            ...
            <Textarea style={{border:'1px solid var(--border-color)', borderRadius:'10px', backgroundColor:'var(--card-bgcolor)'}}
              id="skills" 
              {...register("skills")} 
